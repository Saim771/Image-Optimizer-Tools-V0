...
export const metadata: Metadata = {
  title: "Image Compression Tool | ImageOptimizer",
  description: "Free online tool to compress and optimize your images with adjustable compression levels",
  keywords: "image compression, image optimizer, compress images, reduce image size, image optimization tool",
}
    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground">Compress your images without losing quality</p>
            </div>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Link href="/tools/image-converter" className="block group">
            <div className="bg-card p-6 rounded-xl border border-border/50 hover:shadow-md transition-all">
              <h3 className="text-lg font-semibold mb-2 group-hover:text-primary transition-colors">Image Converter</h3>
              <p className="text-muted-foreground text-sm">Convert between image formats (JPG, PNG, WebP)</p>
            </div>
          </Link>
